  ...
  <head>
    ...
    ?>
     ...
     <div class="panel-body"> 
            <form method="post" action="addbookinsert.php" onsubmit="return Validate()">
                <div class="form-group">
                  <label for="">Book Number</label>
                  <input type="text" class="form-control" id="" placeholder="Book No" name="bookno">
                </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" placeholder="Author" name="author" required>
                </div>
                <div class="form-group">
                  <label for="">Publisher Name</label>
                  <input type="text" class="form-control" id="" placeholder="Publisher" name="publisher" required>
                </div>
                <button type="submit" class="btn btn-default main-color-bg btn-login col-md-4 col-md-offset-4">Add</button>
              </form>
            </div>
 </body>
 </html>